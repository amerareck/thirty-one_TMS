        	...
        	<section style="margin: 0 auto;">
		        <div class="d-flex justify-content-between align-item-center my-2">
		            <div class="w-25 d-flex align-item-center">
		                <h5 class="fw-bold" style="margin:auto 0; color:#5A5A5A;">결재 대기 목록</h5>
		            </div>
		        ...
		        <table class="table table-hover table-header-bg">
		            ...
		            <tbody>
		              <tr>
		                ...
		                <td class="text-center align-middle table-font-size">BST-111-2024-001</td>
		              ...
		              <tr>
		                ...
		                <td class="text-center align-middle table-font-size">WOT-111-2024-010</td>
		                ...
		                <td class="text-center align-middle"><button class="btn btn-outline-secondary btn-ssm">열기</button></td>
		                <td class="text-center align-middle"><img src="../../../resources/image/approval-doing.png" width="50px" height="20px" /></td>
		              </tr>
		            </tbody>
		          </table>
