...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/css/holiday/status.css" />
<link rel="stylesheet"
...
<div class="content-box">
				...
				<div class="holiday-status-box card">
					...
					<div class="holiday-status">
						<div class="holiday-status-detail">
							...
							<div>
								<span>연차 잔여일수</span><span>${annual.hdCount - annual.hdUsed}
									일</span>
							</div>
						</div>
						<div>
				...
				<div class="holiday-list-box card">
						...
						<tbody>
							<c:forEach items="${hdrReqList}" var="hdrReq">
								<tr>
									...
									<td><fmt:formatDate value="${hdrReq.hdrStartDate}"
											pattern="yyyy-MM-dd" /> ~ <fmt:formatDate
											value="${hdrReq.hdrEndDate}" pattern="yyyy-MM-dd" /></td>
									<td><fmt:formatDate value="${hdrReq.hdrSubmittedDate}"
											pattern="MM-dd" /></td>
					...
					<c:when test="${pager.totalRows != 0}">
						...
						<c:if test="${pager.groupNo<pager.totalGroupNo}">
							<a href="?pageNo=${pager.endPageNo+1}"> <img
	...
	contextPath = '${pageContext.request.contextPath}'
		...
		<script type="text/javascript"
			src="${pageContext.request.contextPath}/resources/js/holiday/status.js"></script>
